...
export const adultTherapyService = {
  ...
  detailsTitle: "¿Cómo es nuestra terapia para adultos?",
  details: [
    {
      label: "Duración",
      value: "Sesiones de 50 minutos individuales"
    },
    {
      label: "Modalidad",
      value: "Terapia online con un enfoque cercano"
    },
    {
      label: "Precio",
      value: "55€"
...
export const faqs = [
  {
    ...
    answer:
      "No hace falta estar al límite para empezar. Si algo te genera malestar, se repite en tu vida o te impide vivir con calma, pedir ayuda puede ser una buena decisión."
  },
  {
    question: "¿La primera sesión me compromete a continuar?",
    answer:
      "No. La primera sesión sirve para conocernos, entender tu situación y valorar si el enfoque encaja con lo que necesitas."
  },
  {
  ...
  },
  {
    ...
    answer:
      "Depende del motivo de consulta, los objetivos y la evolución. Lo importante es que el proceso tenga dirección, seguimiento y sentido clínico."
  }
];